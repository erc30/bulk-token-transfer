...
if n == 2:
    ...
    for list_item in list_array:
        temp_tx_url = '''<a href="https://www.cmttracking.io/tx/''' + str(list_item[2]) + '''" target="_blank">''' + list_item[2] + '''</a>'''
        temp_address_url = '''<a href="https://www.cmttracking.io/address/''' + str(list_item[0]) + '''" target="_blank">''' + list_item[0] + '''</a>'''
